        ...
        if (opcion == "1") {
            ...
            if (autorizacionOpcion == "1" || autorizacionOpcion == "pami") {
                ...
                switch (pedido) {
                    ...
                    case 0:
                        break;
                    case (pedido < 1 || pedido > 7):
                        alert(`Dato ingresado no valido, por favor, intentelo nuevamente`); //* si cumple la condicion, saltea pero de todas formas carga una pedido erroneo.
                        choisePedido();
