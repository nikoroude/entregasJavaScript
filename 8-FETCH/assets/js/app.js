...
const cargarPaciente = () => {
    ...
    let cargar = document.addEventListener('click', () => {
        const data = {
        ...
        .then((data) => {
            console.log(data);
            listaPacientes.innerHTML = `<p class="text-white">${data.title}, ${data.body}</p>
                                        <p class="text-white">Fue cargado con exito!</p>`
        })
    })
...
const cargarPedido = () => {
    ...
    let cargar = document.addEventListener('click', () => {
        ...
        .then((data) => {
            console.log(data);
            listaPedidos.innerHTML = `<p class="text-white">${data.title}, ${data.body}</p>
                                        <p class="text-white">Fue cargado con exito!</p>`
        })
    })
